<?php
include CitiesWeatherDetails::class;
...
$get_data = callAPI('https://api.musement.com/api/v3/cities');

$response = json_decode($get_data, true);

$key = 'eaa26ae084274ceb881194737202711';



foreach ($response as $entry) {
    $urls[] = "http://api.weatherapi.com/v1/forecast.json?key=" . $key .'&q=' . $latitude = $entry['latitude'] . "," .   $entry['longitude']
        . '&days=2';
}


$forecasts_array = callMulti($urls);
